...
description: "Revisa conformidade regulatória e legal: LGPD, GDPR, residência de dados, retenção, consentimento, anonimização, direitos do titular e riscos de compliance para sistemas críticos com dados pessoais. Cobre aplicações Java, Python, Go e componentes serverless AWS (Lambda, EventBridge, SQS, SNS, Step Functions, DynamoDB, S3)."
tools:
  - Read
  - Glob
  - Grep
