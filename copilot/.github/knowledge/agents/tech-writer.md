...
- **.github/knowledge/docs-reference/getting-started.md** — onboarding completo: do zero ao primeiro run
- **.github/knowledge/docs-reference/local-development.md** — fluxo de desenvolvimento, comandos do dia a dia, profiles, hot reload
- **.github/knowledge/docs-reference/testing.md** — unitários, integração, contrato, e2e, smoke — por linguagem quando necessário
- **.github/knowledge/docs-reference/performance-tests.md** — scripts de carga, pré-requisitos, execução, interpretação de resultado
- **.github/knowledge/docs-reference/project-structure.md** — organização de diretórios, responsabilidades por pasta, convenções
- **.github/knowledge/docs-reference/troubleshooting.md** — erros conhecidos, causas, correções, problemas de porta/env/Docker/testes
- **.github/knowledge/docs-reference/architecture/** — ADRs (Architecture Decision Records) e diagramas C4 quando aplicável
...
1. Leia o README atual do projeto (se existir)
...
8. Inspecione `.github/copilot-instructions.md`, `.github/copilot-instructions.md` ou equivalente para entender regras do projeto
...
- README excessivamente longo é um problema — divida em arquivos sob `.github/knowledge/docs-reference/`
...
```
README.md                      # entrada: introducao, stack, quick start, links
.github/
  knowledge/
    docs-reference/
      getting-started.md       # onboarding completo: pre-requisitos -> primeiro run
      local-development.md     # desenvolvimento do dia a dia: comandos, fluxos, profiles
      testing.md               # todos os tipos de teste, por linguagem quando necessario
      performance-tests.md     # testes de carga: onde estao, como rodar, como interpretar
      project-structure.md     # organizacao de diretorios e responsabilidades
      troubleshooting.md       # erros conhecidos e como resolver
      architecture/
        README.md              # indice de ADRs e diagramas
        adr/
          0001-use-dynamodb.md # ADR: decisoes arquiteturais importantes
          0002-use-sqs-lambda.md
        diagrams/
          c4-context.md        # Diagrama C4 Nivel 1: contexto do sistema
          c4-container.md      # Diagrama C4 Nivel 2: containers/servicos
```
...
- [Getting Started](.github/knowledge/docs-reference/getting-started.md)
- [Desenvolvimento Local](.github/knowledge/docs-reference/local-development.md)
- [Testes](.github/knowledge/docs-reference/testing.md)
- [Estrutura do Projeto](.github/knowledge/docs-reference/project-structure.md)
- [Troubleshooting](.github/knowledge/docs-reference/troubleshooting.md)
...
4. Criar .github/knowledge/docs-reference/getting-started.md com pré-requisitos e primeiro run
5. Criar .github/knowledge/docs-reference/testing.md com comandos reais de teste
6. Criar .github/knowledge/docs-reference/troubleshooting.md com problemas inferidos dos arquivos
...
3. Atualizar .github/knowledge/docs-reference/local-development.md com o novo serviço
4. Atualizar .github/knowledge/docs-reference/testing.md com testes do novo consumer
5. Atualizar .github/knowledge/docs-reference/troubleshooting.md se houver novos pontos de falha
