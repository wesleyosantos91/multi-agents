...
description: Skill importada do EXEMPLO (software-engineering-process.md).
...
---
name: software-engineering-process
description: "Processo de engenharia de software: design, implementação, code review, deploy e operação. Use quando planejar implementação, definir processo de desenvolvimento, ou avaliar maturidade de engenharia."
---
