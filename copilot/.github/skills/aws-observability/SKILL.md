...
description: Skill importada do EXEMPLO (aws-observability.md).
...
---
name: aws-observability
description: "Observabilidade AWS: CloudWatch Logs, Metrics, Alarms, X-Ray, dashboards e alerting. Use quando configurar monitoramento AWS, criar alarmes, ou diagnosticar problemas em produção AWS."
---
