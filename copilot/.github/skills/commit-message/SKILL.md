---
name: commit-message
description: Skill importada do EXEMPLO (commit-message.md).
...
---
name: commit-message
description: "Gera commit message seguindo Conventional Commits. Use quando pedirem para commitar, criar mensagem de commit ou preparar commit."
---
