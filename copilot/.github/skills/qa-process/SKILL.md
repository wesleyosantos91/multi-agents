---
name: qa-process
description: Skill importada do EXEMPLO (qa-process.md).
...
---
name: qa-process
description: "Processo de QA e engenharia de qualidade: estratégia de testes, critérios de aceite, regressão, edge cases e qualidade de release. Use quando definir processo de QA, planejar testes ou avaliar qualidade de entrega."
---
