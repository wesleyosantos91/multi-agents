...
description: Skill importada do EXEMPLO (spark-data-engineering.md).
...
---
name: spark-data-engineering
description: "Padrões Apache Spark e engenharia de dados: PySpark, Scala, batch, streaming, particionamento, AWS Glue, EMR. Use quando implementar pipelines de dados, ETL/ELT ou processamento distribuído."
---
