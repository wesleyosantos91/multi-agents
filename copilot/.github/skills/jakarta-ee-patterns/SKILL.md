---
name: jakarta-ee-patterns
description: Skill importada do EXEMPLO (jakarta-ee-patterns.md).
...
---
name: jakarta-ee-patterns
description: "Padrões Jakarta EE 11 e MicroProfile 7.0: CDI, JAX-RS, JPA, JMS, Batch, Concurrency, MicroProfile FT/Config/Health. Use quando implementar features em Jakarta EE ou servidores de aplicação (WildFly, Open Liberty, Payara, TomEE)."
---
