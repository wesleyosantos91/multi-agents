---
name: python-testing
description: Skill importada do EXEMPLO (python-testing.md).
...
---
name: python-testing
description: "Testes Python com pytest: fixtures, parametrize, mocks, Testcontainers e cobertura. Use quando criar testes Python ou melhorar cobertura em projetos Python."
---
