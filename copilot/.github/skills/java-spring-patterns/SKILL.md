...
description: Skill importada do EXEMPLO (java-spring-patterns.md).
...
---
name: java-spring-patterns
description: "Padrões e idiomas Spring Boot: beans, segurança, resiliência, messaging, caching, scheduling. Use quando implementar features em Spring Boot ou resolver problemas Spring."
---
