---
name: ios-patterns
description: Skill importada do EXEMPLO (ios-patterns.md).
...
---
name: ios-patterns
description: "Padrões iOS modernos: Swift, SwiftUI, MVVM, async/await, Combine, Core Data, SwiftData, Navigation, testes. Use quando implementar features em iOS nativo."
---
