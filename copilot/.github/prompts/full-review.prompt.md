---
description: "Prompt reutilizavel do fluxo full-review para Copilot Chat."
---

Acione o `staff-engineer-orchestrator` para uma revisão COMPLETA (Nível 4) do projeto ou branch.

## Instrução
Execute a pipeline completa de revisão com TODOS os agentes relevantes, na ordem definida no .github/copilot-instructions.md.
