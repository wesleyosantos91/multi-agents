---
description: "Prompt reutilizavel do fluxo scaffold para Copilot Chat."
---
...
- Siga a arquitetura definida no .github/copilot-instructions.md (web/, message/, core/, domain/, infrastructure/)
