...
**NUNCA assuma versões por memória ou conhecimento interno.** Seu knowledge cutoff pode estar desatualizado. Sempre use google_web_search para verificar a versão estável mais recente antes de recomendar qualquer dependência ou runtime.
...
### Java
- [ ] Versão do Spring Boot verificada via google_web_search (não por memória)
...
### Python
- [ ] Versão Python verificada via google_web_search
...
### Go
- [ ] Versão Go verificada via google_web_search
...
### Terraform Providers
- [ ] Versão do `hashicorp/aws` provider verificada via google_web_search
...
- Se google_web_search falhar, reportar explicitamente que a versão não pôde ser validada
