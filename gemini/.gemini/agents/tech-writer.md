...
8. Inspecione `GEMINI.md`, `AGENTS.md` ou equivalente para entender regras do projeto
...
- Quando tiver acesso ao run_shell_command, execute comandos para confirmar que funcionam antes de documentar
