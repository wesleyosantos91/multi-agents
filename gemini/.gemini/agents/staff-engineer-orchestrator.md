...
0. **dependency-versions-reviewer** — **OBRIGATÓRIO quando há dependências**: valida versões GA via google_web_search (Java, Python, Go, AWS runtimes)
...
Antes de consolidar, verifique que os agentes cobriram todos os itens do **Checklist Transversal Obrigatório** definido no GEMINI.md. Não duplique o checklist aqui — consulte a fonte.
