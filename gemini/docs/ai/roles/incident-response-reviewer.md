...
Ferramentas:
  ...
  - Runbooks: docs/runbooks/ (link direto no alarme CloudWatch)
...
resource "aws_cloudwatch_metric_alarm" "lambda_errors" {
  ...
  alarm_description = "Lambda error rate above threshold. Runbook: https://github.com/<org>/<repo>/blob/main/docs/runbooks/lambda-high-error-rate.md"
}
```
...
- [ ] CloudWatch Alarms configurados for SLO breach?
